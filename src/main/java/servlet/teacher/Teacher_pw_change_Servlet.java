...
/**
 * Servlet implementation class Teacher_pw_change_Servlet
 */
@WebServlet("/Teacher_pw_change_Servlet")
public class Teacher_pw_change_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Teacher_pw_change_Servlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/WEB-INF/jsp/teacher/Teacher_pw_change.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String user_password = teacher.getPassword();
		...
		if(!current_password.equals(user_password)) {
			...
			if(is_change) {
				...
				//ここだけうまくいってない
				request.getRequestDispatcher("/WEB-INF/jsp/teacher/Teacher_pw_change_complete.jsp").forward(request, response);
			}else {
